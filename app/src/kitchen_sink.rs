...
ac turpis"#;
    view! {
        <header>
            <a href="./">Home</a>
            <Avatar image=r#"https://img.freepik.com/premium-vector/product-manager-woman-icon-flat-illustration-product-manager-woman-vector-icon-isolated-white-background_98396-40241.jpg?w=1380"# shape=crate::data_type::shape::Shape::Circular />
        </header>
        <nav>
            <menu>
        ...
        <main>
            ...
            <ol>
                <li>
                    "Lorem "
                    <b>"ipsum dolor sit amet"</b>", consectetuer adipiscing elit."
                </li>
            ...
            <picture>
                ...
                <img src="https://images.unsplash.com/photo-1701505708183-59f709e7d4e6?q=80&w=1032&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    alt="Image of folds" />
            </picture>
            <section>
                <hgroup>
                    ...
                    <p>
                        <q cite="example.com">"Pellentesque habitant morbi tristique senectus"</q>
                        " et netus et "
                        <s>{cite}</s>
                        " egestas."
                        <span>"Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante."</span>
                ...
                <p>
                    <samp>"Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu xslibero sit amet quam egestas semper."</samp>
                ...
                <form>
                    ...
                    <div>
                        ...
                        <input type="password" autocomplete="new-password" name="password_new" id="password_new" />
                    </div>
                    <div>
        ...
        <footer>
            ...
            <a href="#" rel="terms-of-service">"terms of service"</a>
            <a href="#" rel="privacy-policy">"privacy policy"</a>
            <a href="#" rel="license">"license"</a>
